            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Editar Permisos en Roles</h4>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    @method('put')
                        ...
                        <div class="row align-items-center">
                            <div class="form-group col-md-6">
                                <label for="name">Nombre de los Permisos <span class="text-danger">*</span></label>
                            </div>
                        </div>
                        ...
                        <!-- end: Input Data -->
                        <div class="mt-2">
                            <button type="submit" class="btn btn-primary mr-2">Guarfar</button>
