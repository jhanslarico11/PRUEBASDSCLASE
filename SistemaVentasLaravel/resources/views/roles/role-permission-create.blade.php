            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Agregar Permisio en Rol</h4>
                    </div>
                </div>
                    ...
                    @csrf
                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                <label for="role_id">Nombre del Rol <span class="text-danger">*</span></label>
                                <select class="form-control @error('role') is-invalid @enderror" id="role_id" name="role_id" required>
                                    <option selected="" disabled>-- Seleciona Rol --</option>
                        ...
                        <div class="row align-items-center">
                            <div class="form-group col-md-6">
                                <label for="name">Nombre del los Permisos <span class="text-danger">*</span></label>
                                @error('name')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
