            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Pagar Sueldo</h4>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="id" value="{{ $advanceSalary->id }}">
                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                <label for="advance_salary">Adelantado de Sueldo<span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="due_salary">Sueldo Pendiente <span class="text-danger">*</span></label>
                        ...
                        <!-- end: Input Data -->
                        <div class="mt-2">
                            <button type="submit" class="btn btn-primary"><i class="fas fa-money-check-alt mr-2"></i>Pagar</button>
                        </div>
                    </form>
                </div>
            </div>
