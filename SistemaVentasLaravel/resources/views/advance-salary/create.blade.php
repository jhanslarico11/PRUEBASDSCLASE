            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Crear Adelanto de Sueldo</h4>
                    </div>
                </div>
                        ...
                        <div class=" row align-items-center">
                            <div class="form-group col-md-12">
                                ...
                                <select class="form-control mb-3" id="employee_id" name="employee_id" required>
                                    <option selected="" disabled>-- Selecionar Empleado --</option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="datepicker" class="form-control @error('date') is-invalid @enderror" name="date" value="{{ old('date', now()->format('Y-m-d')) }}" />
                                @error('date')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                <label for="advance_salary">Adelanto de Sueldo</label>
