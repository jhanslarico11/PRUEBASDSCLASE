                ...
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <div class="row">
                            <div class="input-group mb-4 col-lg-6">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="product_image">Elegir Foto</label>
                                </div>
                                @error('product_image')
                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                <label for="product_garage">Lugar del Producto</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="product_store">Producto en la Tienda</label>
