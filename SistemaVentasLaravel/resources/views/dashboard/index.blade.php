        ...
        <div class="col-lg-4">
            <div class="card card-transparent card-block card-stretch card-height border-none">
                <div class="card-body p-0 mt-lg-2 mt-0">
                    ...
                    <p class="mb-0 mr-4">El panel de control le ofrece vistas del rendimiento clave o del proceso comercial.</p>
                </div>
            </div>
        </div>
        <div class="col-lg-8">
                    ...
                    <div class="card card-block card-stretch card-height bg-danger">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-4 card-total-sale">
                                ...
                                <div>
                                    <p class="mb-2">Total de deudas</p>
                                    <h4>S/. {{ $total_due }}</h4>
                                </div>
                            </div>
                            <div class="iq-progress-bar mt-2">
                    ...
                    <div class="card-header-toolbar d-flex align-items-center">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow-none"
                                ...
                                <a class="dropdown-item" href="#">Semanas</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card card-block card-stretch card-height mb-0">
                                <div class="card-body">
                                    ...
                                    <div class="style-text text-left mt-3">
                                        ...
                                        <p class="mb-0">{{ $product->product_store }} en Stock</p>
                                    </div>
                                </div>
                            </div>
                        </li>
