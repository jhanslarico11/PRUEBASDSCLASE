...
<div class="container-fluid mb-3">
    ...
    <div class="row px-3">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ml-3">
                            ...
                            <a href="{{ route('users.edit', $user->name) }}" class="btn btn-primary font-size-14">Editar</a>
                            <a href="{{ route('users.index') }}" class="btn btn-danger font-size-14">Atrás</a>
                        </div>
                    </div>
                    <ul class="list-inline p-0 m-0">
                        ...
                        <li class="mb-2">
                            <div class="d-flex align-items-center">
                                ...
                                <p class="mb-0">{{ $user->address ? $user->address : 'Desconocido' }}</p>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <!-- end: Left Detail User -->

        <!-- begin: Right Detail User -->
                        ...
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" value="{{ $user->name }}" readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" value="{{ $user->username }}" readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" value="{{ $user->email }}" readonly>
                                </div>
                            </div>
                        </li>
                    </ul>
